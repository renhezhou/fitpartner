...
public class SpringProgressView extends View {
     ...
     * 分段颜色
     */
    private static final int[] SECTION_COLORS = {Color.parseColor("#FC6419"), Color.parseColor("#FC6419"), Color.parseColor("#FC6419")};
    /**
     * 进度条最大值
     */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int round = mHeight / 2;
        mPaint.setColor(Color.parseColor("#f0f0f4"));
